...
public interface IPatientRepository
{
    ...
    Task<(IReadOnlyList<Patient> Items, int TotalCount)> SearchPagedAsync(BirthDateSearchCriteria? criteria, int skip, int take, CancellationToken cancellationToken);
